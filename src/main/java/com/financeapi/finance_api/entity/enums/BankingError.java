package com.financeapi.finance_api.entity.enums;
...
public enum BankingError {
	...
	// --- ACCOUNT (ACCT_xxx) ---
	ACCOUNT_NUMBER_GENERATION("ACCT_001", "Could not generate unique account number", HttpStatus.INTERNAL_SERVER_ERROR),
	ACCOUNT_NOT_FOUND("ACCT_002", "Account not found", HttpStatus.NOT_FOUND),
